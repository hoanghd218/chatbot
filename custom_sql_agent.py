...
from custom_toolkit import CustomSQLDatabaseToolkit
...
def create_sql_agent(
    ...
    toolkit: Optional[CustomSQLDatabaseToolkit] = None,
    agent_type: Optional[
    ...
    **kwargs: Any,
    ...
    toolkit = toolkit or CustomSQLDatabaseToolkit(llm=llm, db=db)  # type: ignore[arg-type]
