...
examples = [
    {
        "input": "Find invoices in project FJX?",
        "query": """SELECT "Invoice No","Invoice Amt","Invoice Date" FROM invoice_raw WHERE "Project code" = 'FJX'""",
    }
]
...
def main():
    ...
    options = ["Procurement", "Cost progress report"]
